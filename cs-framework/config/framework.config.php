...
$settings           = array(
  ...
  'framework_title' => 'Tema Ayarları <small>by ModPeople</small>',
);
    ...
    array(
      ...
      'fields'    => array(
        array(
          ...
          'accordion_title' => 'Yeni alan ekle',
          'fields'          => array(
    ...
    array(
      ...
      'fields'    => array(
        array(
          'id'          => 'categoryHeader',
          'type'        => 'text',
          'title'       => 'Kategori Genel Başlık',
        ),
        array(
          'id'          => 'categoryText',
          'type'        => 'textarea',
          'title'       => 'Kategori Genel Yazı',
        ),
        ...
        array(
          ...
          'fields'          => array(
            ...
            array(
              ...
              'title'          => 'Kategoriler',
              'options'        => 'categories',
              'default_option' => 'Kategori seçiniz.'
            ),
    ...
    array(
      ...
      'fields'    => array(
        array(
          'id'          => 'about-image',
          'type'        => 'image',
          'title'       => 'Hakkımızda Görsel',
        ),
        array(
          'id'          => 'about-header',
          'type'        => 'text',
          'title'       => 'Hakkımızda Başlık',
          'default'     => 'NEDEN VARNOST',
        ),
        array(
          'id'          => 'about-text',
          'type'        => 'textarea',
          'title'       => 'Hakkımızda Başlık',
          'default'     => 'Varnost olarak güvenlik ihtiyaçlarınızı 360 derece ele alarak tüm bileşenleri sizin için bir araya getiriyoruz. ',
        ),
        array(
          'id'              => 'about_group',
          'type'            => 'group',
    ...
    array(
      ...
      'fields'    => array(
        array(
          ...
          'type'            => 'group',
          'title'           => 'Referans Grup',
          'button_title'    => 'Yeni Referans Ekle',
          'accordion_title' => 'Yeni alan ekle',
          ...
          'fields'          => array(
            ...
            array(
              'id'          => 'Rlogo',
              'type'        => 'image',
              'title'       => 'Referanslar logo',
            ),

            array(
              'id'         => 'Rcat',
              'type'       => 'select',
              'title'      => 'Referans logo Kategorisi',
              'options'            => array(
                'kamu'              => 'KAMU',
                'truzim'            => 'TRUZİM',
                'end'               => 'ENDÜSTRİYEL',
